      ...
      {!below1080 ? (
        <DesktopWrapper>
          ...
          <AutoColumn gap="0.5rem" style={{ marginLeft: '.75rem', marginBottom: '4rem' }}>
            <HeaderText>
              <Link href="https://rexdex.finance" target="_blank">
                Official RexDex
              </Link>
            </HeaderText>
            <HeaderText>
              <Link href="https://smallarmssyndicate.com/" target="_blank">
                Small Arms Syndicate
              </Link>
            </HeaderText>
            <HeaderText>
              <Link href="https://twitter.com/SyndicateSmall" target="_blank">
                Twitter
              </Link>
            </HeaderText>
